...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Keyboard)\n/* harmony export */ });\n/* harmony import */ var _langs_langs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../langs/langs */ \"./src/langs/langs.js\");\n/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./render */ \"./src/utils/render.js\");\n/* harmony import */ var _key__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./key */ \"./src/utils/key.js\");\n\n\n\n\n// render(elem, [classList], [child], parent = null, ...attributes)\n\nclass Keyboard {\n  keys = [\n    ['Backquote', 'Digit1', 'Digit2', 'Digit3', 'Digit4', 'Digit5', 'Digit6', 'Digit7', 'Digit8', 'Digit9', 'Digit0', 'Minus', 'Equal', 'Backspace'],\n    ['Tab', 'KeyQ', 'KeyW', 'KeyE', 'KeyR', 'KeyT', 'KeyY', 'KeyU', 'KeyI', 'KeyO', 'KeyP', 'BracketLeft', 'BracketRight', 'Backslash', 'Delete'],\n    ['CapsLock', 'KeyA', 'KeyS', 'KeyD', 'KeyF', 'KeyG', 'KeyH', 'KeyJ', 'KeyK', 'KeyL', 'Semicolon', 'Quote', 'Enter'],\n    ['ShiftLeft', 'KeyZ', 'KeyX', 'KeyC', 'KeyV', 'KeyB', 'KeyN', 'KeyM', 'Comma', 'Period', 'Slash', 'ArrowUp', 'ShiftRight'],\n    ['ControlLeft', 'MetaLeft', 'AltLeft', 'Space', 'AltRight', 'ArrowLeft', 'ArrowDown', 'ArrowRight', 'ControlRight'],\n  ];\n\n  isShift = false;\n\n  isCaps = false;\n\n  textValue = '';\n\n  isAlt = false;\n\n  isCtr = false;\n\n  build(lang, isShift = false) {\n    this.lang = lang;\n    document.body.innerHTML = '';\n    this.container = (0,_render__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', ['container'], null, document.body);\n    this.textarea = (0,_render__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('textarea', ['textarea'], null, this.container, ['cols', 60], ['rows', 5]);\n    this.textarea.autofocus = true;\n    this.textarea.spellcheck = false;\n    this.textarea.value = this.textValue;\n    let keyContent;\n    if (isShift) keyContent = 'up';\n    else keyContent = 'low';\n\n    this.keys.forEach((item) => {\n      const rowContainer = (0,_render__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', ['row'], null, this.container);\n      item.forEach((el) => {\n        _langs_langs__WEBPACK_IMPORTED_MODULE_0__[\"default\"][this.lang].forEach((key) => {\n          let element;\n          const classList = ['btn'];\n          switch (key.code) {\n            case 'MetaLeft':\n              classList.push('win');\n              break;\n            case 'Space':\n              classList.push('space');\n              break;\n            case 'Tab':\n              classList.push('tab');\n              break;\n            case 'CapsLock':\n              classList.push('caps');\n              break;\n            case 'ShiftLeft':\n              classList.push('shift');\n              break;\n            case 'ControlLeft':\n              classList.push('ctr');\n              break;\n            case 'ControlRight':\n              classList.push('ctr');\n              break;\n            case 'AltLeft':\n              classList.push('alt');\n              break;\n            case 'AltRight':\n              classList.push('alt');\n              break;\n            case 'Backspace':\n              classList.push('backspace');\n              break;\n            case 'Delete':\n              classList.push('del');\n              break;\n            case 'Enter':\n              classList.push('enter');\n              break;\n            case 'ShiftRight':\n              classList.push('shift');\n              break;\n            case 'ArrowLeft':\n              classList.push('arr-left', 'arr');\n              break;\n            case 'ArrowRight':\n              classList.push('arr-right', 'arr');\n              break;\n            case 'ArrowDown':\n              classList.push('arr-down', 'arr');\n              break;\n            case 'ArrowUp':\n              classList.push('arr-up', 'arr');\n              break;\n            default:\n              break;\n          }\n          if (key.code === el) {\n            element = new _key__WEBPACK_IMPORTED_MODULE_2__[\"default\"](key.small, key.shift, key.code);\n            if (key.code === 'CapsLock' && this.isCaps) classList.push('_active');\n            if (this.isCaps && !this.isShift) {\n              if (element.isCapsable) {\n                this[element.code] = (0,_render__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', classList, element.low, rowContainer);\n                this[element.code].key = element;\n              } else {\n                this[element.code] = (0,_render__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', classList, element.up, rowContainer);\n                this[element.code].key = element;\n              }\n            } else {\n              this[element.code] = (0,_render__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', classList, element[keyContent], rowContainer);\n              this[element.code].key = element;\n            }\n            this[element.code].addEventListener('click', () => {\n\n            });\n          }\n        });\n      });\n    });\n  }\n}\n\n\n//# sourceURL=webpack://virtual-keyboard/./src/utils/keyboard.js?");
